/********************************************************************************
** Form generated from reading UI file 'mainwindowe10196.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_3->setGeometry(QRect(20, 20, 351, 481));
        verticalLayoutWidget_3 = new QWidget(centralwidget);
        verticalLayoutWidget_3->setObjectName(QStringLiteral("verticalLayoutWidget_3"));
        verticalLayoutWidget_3->setGeometry(QRect(20, 40, 335, 463));
        ...
        doubleSpinBox_set_roll->setSingleStep(1);
        ...
        doubleSpinBox_set_pitch->setSingleStep(1);
        ...
        doubleSpinBox_set_yaw->setSingleStep(1);
