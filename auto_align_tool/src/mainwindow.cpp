        ...
        ui(new Ui::MainWindow)
{
    ...
    path_ = ros::package::getPath("auto_align_tool") + "/save_config/";
//    path_ = "/home/mjj/ros_project/auto_align/src/auto_align/save_data/";
...
void MainWindow::trans_changed(const double& trans_value){
    ...
    std::cout<<"fdfafdfa: "<<ui->doubleSpinBox_set_roll->value()<<std::endl;
    ...
    str_msg += " ";
    str_msg += num2str(ui->doubleSpinBox_set_roll->value()*pi_over_180);
    str_msg += " ";
    str_msg += num2str(ui->doubleSpinBox_set_pitch->value()*pi_over_180);
    str_msg += " ";
    str_msg += num2str(ui->doubleSpinBox_set_yaw->value()*pi_over_180);
